...
export class MovieRepository {
    ...
    constructor() {
        this.movies = [
            ...
            { id: 5, title: "film 5", description: "film 5 açıklama", imageUrl: "5.jpeg", isPopular:true},
        ];
    }
    getMovies(): Movie[] {
        return this.movies; 
    ...
    getMovieById(id: number): Movie {
        return this.movies.find(i => i.id == id);              //tsconfig.jsona "strictNullChecks": false ekle
    }
}